...
import { Home, User, Tag, Database, LogOut, MapPin, Box, Users, DollarSign, Utensils, Layout, Settings, Thermometer } from 'lucide-react'; 
...
const Sidebar = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-red-800 to-red-500 text-white w-40 min-h-screen flex flex-col items-center py-20 space-y-10 rounded-tr-2xl rounded-2xl m-8">
      ...
      <button onClick={() => navigate('/descount')}><DollarSign size={24} /></button>
